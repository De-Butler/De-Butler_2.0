...
export const MainPartner = () => {
  ...
  const partners = [
    {
      name: 'YourD',
      link: 'https://www.yourd.xyz/',
      image: YourD,
      width: 'w-16 sm:w-24',
    },
    {
      name: 'Near',
      link: 'https://nearkorea.org/',
      image: Near,
      width: 'w-20 sm:w-36',
    },
    ...
    {
      name: 'MetaWeek',
      link: 'https://seoulmetaweek.com/ko/',
      image: Meta,
      width: 'w-24 sm:w-36',
    },
    {
      name: 'Chain3',
      link: 'https://chain.partners/history-korean/',
      image: Chain3,
      width: 'w-28 sm:w-36',
    },
  ];
  const cooperations = [
    {
      name: 'LBank',
      link: 'https://www.lbank.com/ko-KR/',
      image: LBank,
      width: 'w-24 sm:w-40',
    },
